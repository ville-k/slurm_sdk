...
class TestGetAccountJobs:
    ...
    def test_get_account_jobs_parses_output(self, mock_run_cmd, mock_connect):
    ...
    @patch.object(SSHCommandBackend, "_connect", return_value=None)
    @patch.object(SSHCommandBackend, "_run_command")
    def test_get_account_jobs_skips_job_steps(self, mock_run_cmd, mock_connect):
    ...
    @patch.object(SSHCommandBackend, "_connect", return_value=None)
    @patch.object(SSHCommandBackend, "_run_command")
    def test_get_account_jobs_empty_result(self, mock_run_cmd, mock_connect):
